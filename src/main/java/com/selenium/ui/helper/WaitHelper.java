...
public class WaitHelper {
	 ...
	 * @return
	 */
	public WebDriverWait getWait(WebDriver driver,Duration timeoutinseconds, int pollingmillisecs) {
	...
	public WebElement waitForElementVisible(WebDriver driver,By locator, int timeout, int polling) {
		...
		WebDriverWait wait = getWait(driver, Duration.ofDays(timeout), polling);
