...
public class MemberRegistrationMyPhysicianPlanTest extends TestBase {
    ...
    public void TC021_EmployerRegistration(String rowID, String description, JSONObject data) throws Exception {
    ...
    public void TC022_EmployerRegistrationWithCheckEmployeeLogin (String rowID, String description, JSONObject data) throws Exception {
        new LoginPage().launchApplication();
        new RegisterPageUSEmployers().clickRegister();
        new RegisterPageUSEmployers().clickUSEmployers();
        new RegisterPageUSEmployers().selectEmployerRegistration();
    ...
    public void TC023_EmployerRegistrationWithCheckBusinessLogin (String rowID, String description, JSONObject data) throws Exception {
        new LoginPage().launchApplication();
   ...
   @Test(groups = {"Smoke_Test_NewUX", "Browserstack"}, dataProvider = "TestData", dataProviderClass = JsonDataProvider.class, description = "Verify the Registered User With Flexible USCare with Initial Unshareable Amount (IUA)", priority = 26)
    ...
    public void TC028_RegistrationWithPreExistingMembers(String rowID, String description, JSONObject data) throws Exception {
        new LoginPage().launchApplication();
